...
@section('title', 'Editează Elev')
@section('header', 'Editează Elev: ' . $elev->nume_complet)
            ...
            <form action="{{ route('elevi.update', $elev->id) }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nume" id="nume" value="{{ old('nume', $elev->nume) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="prenume" id="prenume" value="{{ old('prenume', $elev->prenume) }}" required
                ...
                <div class="grid grid-cols-2 gap-6 mt-6">
                    <div>
                        ...
                        <input type="text" name="numar_matricol" id="numar_matricol" value="{{ old('numar_matricol', $elev->numar_matricol) }}" required
                    ...
                    <div>
                        ...
                        <select name="clasa_id" id="clasa_id" required
                            ...
                            @foreach($clase as $clasa)
                                <option value="{{ $clasa->id }}" {{ old('clasa_id', $elev->clasa_id) == $clasa->id ? 'selected' : '' }}>
                                    {{ $clasa->nume_complet }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="grid grid-cols-2 gap-6 mt-6">
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email', $elev->email) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="telefon" id="telefon" value="{{ old('telefon', $elev->telefon) }}"
                ...
                <div class="grid grid-cols-2 gap-6 mt-6">
                    <div>
                        ...
                        <input type="date" name="data_nasterii" id="data_nasterii" 
                            value="{{ old('data_nasterii', $elev->data_nasterii ? $elev->data_nasterii->format('Y-m-d') : '') }}"
                    ...
                    <div class="flex items-center">
                        <div class="mt-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="activ" value="1" {{ old('activ', $elev->activ) ? 'checked' : '' }}
                                    class="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded">
                                <span class="ml-2 text-sm text-gray-700">Elev activ</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="observatii" id="observatii" rows="3"
                        ...
                        placeholder="Observații despre elev...">{{ old('observatii', $elev->observatii) }}</textarea>
                    @error('observatii')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
